...
export default function Home() {
    ...
    const[contact,setContact]=useState({"firstName":"","lastName":"","email":"","picture":"",userId})
...
async function addContact(e){
    e.preventDefault();
    let{data}=await axios.post("https://dummyapi.io/data/v1/user/create",contact,{headers:{"app-id":userId}})
console.log(data)
if(data){
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body d-flex mx-2">
                             <input onChange={getContact} placeholder="firstName" name="firstName" className="form-control mx-2" type="text" />
                             <input onChange={getContact} placeholder="lastName" name="lastName" className="form-control mx-2" type="text" />
